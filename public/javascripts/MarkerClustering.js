//https://github.com/navermaps/marker-tools.js  마커클러스터 js tool 링크.  marker-clustering => src => MarkerClustering.js => raw로 원본코드 띄운뒤 복붙
//index.ejs에서 <script type="text/javascript" src="/javascripts/main.js"></script>  위에 마커클러스터.js를 불러오는 코드 작성
//위에 쓰는 이유는 main.js에서 마커클러스터.js를 사용할거라서 main위에 마커클러스터를 불러오는 스크립트를 작성해야한다
